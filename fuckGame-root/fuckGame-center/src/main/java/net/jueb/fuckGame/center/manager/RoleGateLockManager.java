 ...
 */
public class RoleGateLockManager {
	protected final Logger _log=Log4jUtil.getLogger(getClass());
	private static RoleGateLockManager instance;
	private static final Object lock=new Object();
	
	private final Map<Long,Integer> role_server=new ConcurrentHashMap<Long,Integer>();
	
	private RoleGateLockManager(){};
	
	public static RoleGateLockManager getInstance()
	{
		if(instance==null)
		{
			synchronized (lock) {
				if(instance==null)
				{
					instance=new RoleGateLockManager();
				}
			}
		}
		return instance;
	 ...
	 * @param serverId
	 */
	public void unlockByServer(int serverId)
	{
